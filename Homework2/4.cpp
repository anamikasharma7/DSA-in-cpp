...
//case1:create a program that asks the user for their age 
//case2:checks if they qualify for a discounted ticket price (e.g., under 12 and over 65 get discounts),
//CASE3: If they are eligible print “YES” else “NO”.
#include<iostream>
using namespace std;
int main(){
    int age;
